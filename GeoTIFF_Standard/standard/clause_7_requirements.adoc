== Requirements
This OGC Standard specifies the content and structure of a group of industry-standard tag sets for the management of georeference or geocoded raster imagery using Aldus-Adobe's public domain Tagged-Image File Format (TIFF).
...
=== Coordinate Tranformation Requirements

For most common applications, the transformation between raster and model space may be defined with a set of raster-to-model tiepoints and scaling parameters. The ModelTiepointTag and ModelPixesScaleTag may be used for this purpose.
...
The IntergraphMatrixTag has been deprecated and should not be used. It is included in this version of the GeoTIFF standard for completeness.

==== Requirements Class ModelTiepointTag

include::requirements/Model_Tags/requirements_class_ModelTiepointTag.adoc[]

==== Requirements Class ModelPixelScaleTag

include::requirements/Model_Tags/requirements_class_ModelPixelScaleTag.adoc[]

==== Requirements Class ModelTransformationTag

include::requirements/Model_Tags/requirements_class_ModelTransformationTag.adoc[]

==== Requirements Class IntergraphMatrixTag

include::requirements/Model_Tags/requirements_class_ItergraphMatrixTag.adoc[]
