...
NOTE: It is a practice in some Communities to indicate a geographic 3D CRS (with ellipsoidal height) by including the code of the geographic 3D CRS in a VerticalGeoKey. See <<annex-d.adoc#section-D.3, Geographic 3D CRS (case of ellipsoidal height)>>.
