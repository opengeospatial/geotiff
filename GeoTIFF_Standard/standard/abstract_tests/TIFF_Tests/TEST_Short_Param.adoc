...
[width="100%"]
|===
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoKeyDirectoryTag.KeyEntry.ID 
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoKeyDirectoryTag.keyEntryTIFFTagLocation 
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoKeyDirectoryTag.keyEntryKeyCount 
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoKeyDirectoryTag.keyEntryValueOffset
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoShortParams.Criteria 
|http://www.opengis.net/spec/GeoTIFF/0.0/req/GeoShortParams.Location
