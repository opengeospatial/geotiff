...
| The GeodeticCRSGeoKey SHALL have ID = 2048 |TIFF_Test/ShortParameters, GeodeticCRSGeoKey Test
| The GeodeticCRSGeoKey SHALL have type = SHORT |TIFF_Test/ShortParameters, GeodeticCRSGeoKey Test
| GeodeticCRSGeoKey values in the range 1-1000 SHALL be obsolete EPSG/POC Geographic Codes |GeodeticCRSGeoKey Test
| GeodeticCRSGeoKey values in the range 1001-1023 SHALL be reserved. |GeodeticCRSGeoKey Test
| GeodeticCRSGeoKey values in the range 1024-32766 SHALL be EPSG geodetic CRS codes (geographic 2D CRS, geographic 3D CRS, and geocentric CRS) |GeodeticCRSGeoKey Test
| If the GeodeticCRSGeoKey value is 32767 (User-Defined) then the GeodeticCitationGeoKey, GeodeticDatumGeoKey and at least one of GeogAngularUnitsGeoKey or GeogLinearUnitsGeoKey SHALL be populated. |GeodeticCRSGeoKey Test
| GeodeticCRSGeoKeyvalues in the range 32768-65535 SHALL be private |GeodeticCRSGeoKey Test
