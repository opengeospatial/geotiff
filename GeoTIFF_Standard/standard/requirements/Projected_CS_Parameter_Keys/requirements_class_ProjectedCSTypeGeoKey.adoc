...
|Requirement {set:cellbgcolor:#CACCCE}
|http://www.opengis.net/spec/GeoTIFF/0.0/ProjectedCSTypeGeoKey.user_defined +
_A ProjectedCSTypeGeoKey with a value of 32767 shall be considered user defined_
{set:cellbgcolor:#FFFFFF}
