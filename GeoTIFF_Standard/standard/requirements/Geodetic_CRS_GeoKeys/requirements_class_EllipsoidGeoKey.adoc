...
2+|http://www.opengis.net/spec/GeoTIFF/0.0/EllipsoidGehttp://www.opengis.net/spec/GeoTIFF/0.0/EllipsoidGeoKey
{set:cellbgcolor:#FFFFFF}oKey
...
NOTE: In GeoTIFF v1.0 the range was 7000-7999. Several values in this range have been deprecated or deleted from the EPSG Dataset and should no longer be used. See <<annex-b.adoc#deprecated_ellipsoid_codes,Table B.5 - Deprecated and deleted EPSG ellipsoid codes>>
{set:cellbgcolor:#FFFFFF}
