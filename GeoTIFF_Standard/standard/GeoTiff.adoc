...
:titletext: OGC GeoTIFF Standard
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
This document is an OGC Member approved international standard.
This document is available on a royalty free, non-discriminatory basis.
...
include::clause_7_requirements.adoc[]
