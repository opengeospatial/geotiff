...
This section is for documenting backward compatibility of the use of CRS or projection codes in GeoTIFF with version 1.0, and may be ignored for users that use the GeoTIFF register (EPSG register) for identification of CRS and projection.
